...
module.exports = "<div style=\"text-align:center\">\n  <h1>\n    Welcome to {{title}}!\n  </h1>\n  \n</div>\n<ul>\n<li *ngFor=\"let user of userlist\">{{user.name}}</li>\n</ul>\n<div>\n  <h2>Add User</h2>\n  <form (ngSubmit)=\"postForm(name.value,age.value,address.value);name.value='';age.value='';address.value=''\">\n    <table>\n      <tr><td><label>Enter Name:</label></td><td><input type=\"text\" #name name=\"name\" /></td></tr>\n      <tr><td><label>Enter Age:</label></td><td><input type=\"text\" #age name=\"age\" /></td></tr>\n      <tr><td><label>Enter Address:</label></td><td><input type=\"text\" #address name=\"address\" /></td></tr>\n      <tr><td><input type=\"submit\" value=\"Add\" /></td></tr>\n    </table>\n   </form>  \n</div>\n\n\n\n"
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.fetchUserData = function () {
        var _this = this;
        //Ajax GET request for '/api/users'
        //Components are never tied with data 
        this.userservice.getUsers().then(function (data) {
            _this.userlist = data; //Handle the response;
        });
    };
    AppComponent.prototype.postForm = function (name, age, address) {
        var _this = this;
        //Ajax POST request and send the data  
        this.userservice.adduser(name, age, address).then(function (data) {
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["L" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["b" /* HttpClientModule */], __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormsModule */]
        ],
...
var UserService = (function () {
    ...
    UserService.prototype.adduser = function (name, age, address) {
